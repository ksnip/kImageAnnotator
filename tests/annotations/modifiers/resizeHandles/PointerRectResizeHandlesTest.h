...
#ifndef KIMAGEANNOTATOR_POINTERRECTRESIZEHANDLESTEST_H
#define KIMAGEANNOTATOR_POINTERRECTRESIZEHANDLESTEST_H

#include <QtTest>

#include "tests/utils/TestRunner.h"
#include "src/annotations/modifiers/resizeHandles/PointerRectResizeHandles.h"
#include "src/annotations/items/AnnotationNumberPointer.h"
#include "src/common/helper/CursorHelper.h"

using kImageAnnotator::PointerRectResizeHandles;
...
class PointerRectResizeHandlesTest : public QObject
{
Q_OBJECT
private slots:
	void TestInitHandles_Should_PositionPointerHandle_When_PointerRectItemProvided();
	...
	void TestHandle_Should_ReturnPointerRectAtIndex_When_HandleAtIndexExists();
	...
	void TestUpdate_Should_MovePointerHandlesToNewPosition();
};


#endif //KIMAGEANNOTATOR_POINTERRECTRESIZEHANDLESTEST_H
