...
#ifndef KIMAGEANNOTATOR_ANNOTTIONITEMCLIPBOARDTEST_H
#define KIMAGEANNOTATOR_ANNOTTIONITEMCLIPBOARDTEST_H
...
private slots:
	void TestCopyItems_Should_StoreSelectedItems();
	void TestCopyItems_Should_SetCorrectOffset();
};

#endif // KIMAGEANNOTATOR_ANNOTTIONITEMCLIPBOARDTEST_H
